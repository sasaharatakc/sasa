...
const SERVICE_ICONS = [Factory, Boxes, Truck, Globe2];
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 sm:px-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 max-w-md text-white/70">{m.footer.desc}</p>
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-sm text-white/50 sm:flex-row">
          ...
          <span className="font-display tracking-wider2">{m.footer.tagline}</span>
        </div>
      </div>
    </footer>
  );
